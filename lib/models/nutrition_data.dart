class NutritionData {
  ...
  factory NutritionData.fromJson(Map<String, dynamic> json) {
    final micros = json['micros'] as Map<String, dynamic>?;

    double toDouble(dynamic v) => v == null ? 0.0 : (v as num).toDouble();
    double? nd(List<String> keys) {
      for (final key in keys) {
        final val = json[key] ?? (micros != null ? micros[key] : null);
    ...
    return NutritionData(
      ...
      monoFat: nd(const ['monoFat']),
      polyFat: nd(const ['polyFat']),
      transFat: nd(const ['transFat']),
      cholesterol: nd(const ['cholesterol']),
      selenium: nd(const ['selenium', 'selenyum']),
      magnesium: nd(const ['magnesium', 'magnezyum']),
      iron: nd(const ['iron', 'demir']),
      zinc: nd(const ['zinc', 'cinko']),
      calcium: nd(const ['calcium', 'kalsiyum']),
      potassium: nd(const ['potassium', 'potasyum']),
      sodium: nd(const ['sodium', 'sodyum']),
      phosphorus: nd(const ['phosphorus']),
      copper: nd(const ['copper']),
      manganese: nd(const ['manganese']),
      vitaminA: nd(const ['vitaminA', 'vitamin_a']),
      vitaminC: nd(const ['vitaminC', 'vitamin_c']),
      vitaminD: nd(const ['vitaminD', 'vitamin_d', 'd_vitamini']),
      vitaminE: nd(const ['vitaminE', 'vitamin_e']),
      vitaminK: nd(const ['vitaminK', 'vitamin_k']),
      vitaminB12: nd(const ['vitaminB12', 'vitamin_b12', 'b12']),
      thiamine: nd(const ['thiamine']),
      riboflavin: nd(const ['riboflavin']),
      niacin: nd(const ['niacin']),
      pantothenic: nd(const ['pantothenic']),
      vitaminB6: nd(const ['vitaminB6', 'vitamin_b6']),
      folate: nd(const ['folate', 'folat']),
      choline: nd(const ['choline']),
      biotin: nd(const ['biotin']),
      omega3: nd(const ['omega3']),
      omega6: nd(const ['omega6']),
      ala: nd(const ['ala']),
      epa: nd(const ['epa']),
      dha: nd(const ['dha']),
      tryptophan: nd(const ['tryptophan']),
      threonine: nd(const ['threonine']),
      isoleucine: nd(const ['isoleucine']),
      leucine: nd(const ['leucine']),
      lysine: nd(const ['lysine']),
      methionine: nd(const ['methionine']),
      phenylalanine: nd(const ['phenylalanine']),
      valine: nd(const ['valine']),
      histidine: nd(const ['histidine']),
      betaCarotene: nd(const ['betaCarotene', 'beta_karoten']),
      lycopene: nd(const ['lycopene', 'likopen']),
      luteinZeaxanthin: nd(const ['luteinZeaxanthin', 'lutein_zea']),
      alphaCarotene: nd(const ['alphaCarotene', 'alfa_karoten']),
